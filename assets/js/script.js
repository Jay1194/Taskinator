...
var createTaskEl = function(taskDataObj) {
  ...
  // added dynamic id to (taskDataObj) object
...
var deleteTask = function(taskId) {
   ...
   // loop through cureent tasks
   for (var i = 0; i < tasks.length; i++) {

    // if tasks[i].id dosint match the value of taskId, let's keep that task and push it into new array
    if (tasks[i].id !== parseInt(taskId)) {
...
var taskStatusChangeHandler = function (event) {
    ...
    // get the task items id - make sure event target right handler
